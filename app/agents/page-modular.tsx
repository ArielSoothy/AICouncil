...
import { DebateContainer, DebateErrorBoundary } from '@/features/debate/components/DebateContainer'
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Use the new modular debate container with error boundary */}
          <DebateErrorBoundary>
            <DebateContainer userTier={effectiveUserTier} />
          </DebateErrorBoundary>
        </div>
      </main>
    </div>
