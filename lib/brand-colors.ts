...
// Generic icons for each provider (using emojis - safe and legal)
export const PROVIDER_ICONS = {
  anthropic: '🧠', // Brain for Claude's intelligence
  openai: '⚡', // Lightning for GPT's speed
  google: '🔍', // Search for Google
  groq: '🚀', // Rocket for Groq's speed
  xai: '✨', // Sparkles for Grok's creativity
  perplexity: '🔎', // Magnifying glass for search
  mistral: '💨', // Wind for Mistral
  cohere: '🔗', // Link for Cohere
} as const
