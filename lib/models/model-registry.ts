...
export const MODEL_REGISTRY: Record<Provider, ModelInfo[]> = {
  ...
  groq: [
    ...
    // Gemma (DECOMMISSIONED - October 2025)
    { id: 'gemma2-9b-it', name: 'Gemma 2 9B', provider: 'groq', tier: 'free', badge: '🎁', status: 'parameter_error', isLegacy: true, lastTested: '2025-10-30T00:00:00.000Z', notes: 'DECOMMISSIONED by Groq - see https://console.groq.com/docs/deprecations' }
  ],
